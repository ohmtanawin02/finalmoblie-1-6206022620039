              ...
              children: <Widget>[
                TextField(
                  ...
                  decoration: const InputDecoration(
                      hintText: "Enter appdb name", labelText: 'Name:'),
                ),
                TextField(
                  controller: _typeController,
                  decoration: const InputDecoration(
                      hintText: "Enter appdb type", labelText: 'Email:'),
                ),
                TextField(
                  controller: _descriptionController,
                  decoration: const InputDecoration(
                      hintText: "Enter appdb description", labelText: 'Phone:'),
                ),
                TextField(
                  controller: _amountController,
                  decoration: const InputDecoration(
                      hintText: "Enter appdb amount", labelText: 'Address:'),
                ),
                TextField(
                  controller: _amountController,
                  decoration: const InputDecoration(
                      hintText: "Enter appdb createdAt", labelText: 'Address:'),
                ),
